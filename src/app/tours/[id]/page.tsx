        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          ...
          <div className="bg-[#f5f5f7] rounded-3xl p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-[#c41e3a] font-semibold mt-2">{t.form.tourName} {seasonal.name[locale]}</p>
            </div>
            ...
            <form
              onSubmit={(e) => {
                ...
                const mailSubject = `${locale === "es" ? "Consulta" : "Inquiry"}: ${seasonal.name[locale]}`;
                const body = `${t.form.tourName} ${seasonal.name[locale]}\n\n${t.form.name}: ${name}\n${t.form.email}: ${email}\n${t.form.country}: ${country}\n${t.form.phone}: ${phone}\n${t.form.adults}: ${adults}\n${t.form.children}: ${children || "-"}\n\n${message}`;
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input name="name" required placeholder={t.form.name} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:border-[#c41e3a] focus:ring-2 focus:ring-[#c41e3a]/20 outline-none transition-all text-sm" />
                <input name="email" type="email" required placeholder={t.form.email} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:border-[#c41e3a] focus:ring-2 focus:ring-[#c41e3a]/20 outline-none transition-all text-sm" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input name="country" required placeholder={t.form.country} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:border-[#c41e3a] focus:ring-2 focus:ring-[#c41e3a]/20 outline-none transition-all text-sm" />
                <input name="phone" required placeholder={t.form.phone} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:border-[#c41e3a] focus:ring-2 focus:ring-[#c41e3a]/20 outline-none transition-all text-sm" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input name="adults" type="number" min="1" required placeholder={t.form.adults} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:border-[#c41e3a] focus:ring-2 focus:ring-[#c41e3a]/20 outline-none transition-all text-sm" />
                <input name="children" type="number" min="0" placeholder={t.form.children} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:border-[#c41e3a] focus:ring-2 focus:ring-[#c41e3a]/20 outline-none transition-all text-sm" />
              </div>
              <textarea name="message" required rows={4} placeholder={t.form.message} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:border-[#c41e3a] focus:ring-2 focus:ring-[#c41e3a]/20 outline-none transition-all text-sm resize-none" />
              ...
              <button type="submit" className="w-full py-3 bg-[#c41e3a] text-white text-sm font-semibold rounded-xl hover:bg-[#a01830] transition-colors">
                {t.form.send}
              </button>
            </form>
            ...
            <div className="text-center mt-6">
              ...
              <div className="flex justify-center gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-800 text-white text-sm font-semibold rounded-xl hover:bg-gray-900 transition-colors"
                >
